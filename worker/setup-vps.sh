...
echo "  # Opcional: COMPRASGOV_ENV=treinamento  (para testes sem risco)"
echo "  # Opcional: DEBUG_SCREENSHOTS=true       (salva PNGs para diagnóstico)"
echo ""
echo "Gerando WORKER_SECRET seguro:"
echo "  openssl rand -hex 32"
echo ""
echo "Testando login antes de iniciar:"
echo "  cd /opt/licitah-worker"
echo "  CPF=seu_cpf SENHA=sua_senha npm run diagnostico"
echo ""
